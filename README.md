...
This project was built as part of the [**CMP Android & iOS Course**](https://pl-coding.com/cmp-mobile "null") by **Philipp Lackner**, created in collaboration with **JetBrains**.
