...
/**
 * Represents the style of a button used in the ChirpButton composable.
 * Defines visual and interactive behavior of the button based on its purpose.
 */
...
/**
 * A composable function that renders a button with customizable styles, icons, and loading state.
 *
 ...
 * @param style The style of the button, defined by [ChirpButtonStyle]. Defaults to [ChirpButtonStyle.PRIMARY].
 * @param enabled A boolean indicating whether the button is enabled or disabled. Defaults to `true`.
 * @param isLoading A boolean indicating whether a loading indicator should be displayed. Defaults to `false`.
 * @param leadingIcon An optional composable function to provide a leading icon displayed before the text. Defaults to `null`.
 */
@Composable
fun ChirpButton(
    text: String,
