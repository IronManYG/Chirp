package dev.gaddal.chat.presentation.profile.components
...
/**
 * Displays an overlay component for drag-and-drop operations.
 * This overlay is styled with a dark background and includes an icon
 * and a text message to guide users during the drag-and-drop process.
 *
 * @param modifier Modifier to be applied to the root layout of the overlay.
 */
@Composable
