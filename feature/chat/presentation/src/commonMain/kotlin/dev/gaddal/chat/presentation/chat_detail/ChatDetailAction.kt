...
/**
 * Represents user actions or interactions within the chat detail screen.
 * Each implementation of this sealed interface corresponds to a specific action
 * that can trigger state changes or events in the chat detail UI.
 */
